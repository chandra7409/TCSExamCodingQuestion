// function placeCow(cows, stalls, noOfStalls, mid) {
//     let indexOfStallOfLastCowPlace = 0;
//     cows--;

//     for (let stallIdx = 1; stallIdx < noOfStalls; stallIdx++) {
//         if (stalls[stallIdx] - stalls[indexOfStallOfLastCowPlace] >= mid) {
//             cows--;
//             indexOfStallOfLastCowPlace = stallIdx;
...
// let largest = minDistanceBetweenCows(noOfStalls, stalls, cows);
// console.log(largest);

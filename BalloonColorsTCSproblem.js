...
// Note: If there is more than one colour which is odd in number, then the first colour in the array which is present odd number of times is displayed.The colours of the balloons can all be either upper
// case or lower
// case inthe array.If all the inputs are even in number, display the message“ All are even”.

// Example 1:

//     7 - > Value of N[r, g, b, b, g, y, y] - > B[] Elements B[0] to B[N - 1], where each input element is sepārated by ṉew line.
//     Output:
...
//     First input: Accept value
//     for number of N(Positive integer number).
